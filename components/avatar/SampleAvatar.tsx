...
export default class MainScene extends Phaser.Scene {
  ...
  private readonly partsToLoad: PartAssetConfig[] = [
    // 1. 기본 신체 (Body & Head)
    {
      type: "body",
      key: "body_male_light",
      path: "/assets/spritesheets/body/teen/light.png",
    },
    {
      type: "head",
      key: "head_male_light",
      path: "/assets/spritesheets/head/heads/human/male/light.png",
    },
    ...
    // 2. 얼굴 요소 (Eyes, Nose - 필요 시 추가)
    {
      type: "nose",
      key: "nose_light",
      path: "/assets/spritesheets/nose/button/adult/light.png",
    },
    {
      type: "eyes",
      key: "eyes_blue",
      path: "/assets/spritesheets/eyes/human/adult/blue.png",
    },

    // 3. 스타일 파츠 (Hair, Clothes)
    {
      type: "hair",
      key: "hair_messy_raven",
      path: "/assets/spritesheets/hair/idol/male/red.png",
    },
    {
      type: "torso",
      key: "torso_tshirt_white",
      path: "/assets/spritesheets/torso/clothes/longsleeve/teen/white.png",
    },
    {
      type: "legs",
      key: "legs_pants_teal",
      path: "/assets/spritesheets/legs/cuffed/teen/black.png",
    },
    {
      type: "feet",
      key: "feet_shoes_black",
      path: "/assets/spritesheets/feet/shoes2/thin/black.png",
    },
  ];
  ...
  public changePart(partName: PartType, assetKey: string) {
    ...
    if (this.textures.exists(assetKey)) {
      ...
      console.warn(
        `[MainScene] Asset key not found: ${assetKey}. Make sure to add it to partsToLoad.`
      );
    }
  }
