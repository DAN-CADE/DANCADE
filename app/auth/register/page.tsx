...
export default function RegisterPage() {
  ...
  const onSubmit: SubmitHandler<RegisterInput> = async (data) => {
    ...
    try {
      ...
      // 4. 완료 후 캐릭터 선택 페이지로 이동 (로그인 페이지 스킵 - 자동 로그인)
      // alert 없이 바로 이동
          ...
          >
            <fieldset className="form-fields space-y-6">
                    ...
                    <div>
                      ...
                      {guestPoints > 0 && (
                        <p className="text-sm text-[var(--color-navy)]">
                          ...
                          <span className="mx-2 text-[var(--color-pink)]">
                            •
                          </span>
              ...
              <div className="form-field flex flex-col lg:flex-row lg:items-start">
                <label
                  htmlFor="userid"
                  className="text-black mb-2 lg:mb-0 lg:w-[140px] font-bold text-base lg:text-lg whitespace-nowrap"
                >
              ...
              <div className="form-field flex flex-col lg:flex-row lg:items-start">
                <label
                  ...
                  className="text-black mb-2 lg:mb-0 lg:w-[140px] font-bold text-base lg:text-lg"
                >
                  <span className="inline-block bg-[var(--color-pink)]/10 px-3 py-2 rounded-md lg:bg-transparent lg:px-0 lg:py-0">
                    비밀번호
